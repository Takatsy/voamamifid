...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Sasy</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-12">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12">
                    <input type="number" name="Montant" value="<?= $sazy->Montant ?>" class="form-control" placeholder ="Montant d'un sazy">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12">
                    <input type="text" name="Observation" value="<?= $sazy->Observation?>" class="form-control" placeholder ="Observation">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputNumber" class="col-sm-4 col-form-label">Date </label>
                    <div class="col-sm-12">
                    <input type="date" name="Date"  value="<?= $sazy->Date ?>"class="form-control" placeholder ="nombre">
                    </div>
                </div>
