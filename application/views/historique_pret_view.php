...
<section class="section">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Historique prêt</h5>
          ...
          <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                      <p name="fullName" type="text" class="form-control" id="fullName" value=""> <?= $pret->Montant ?> Ar</p>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                      <p name="fullName" type="text" class="form-control" id="fullName" value=""> <?= $pret->Date_pret ?> </p>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Montant à rembourser</label>
                      <div class="col-md-8 col-lg-9">
                      <p name="fullName" type="text" class="form-control" id="fullName" value=""> <?= number_format($montantrembourser, 0, ',', ' ') ?> Ar</p>
                      </div>
                    </div>
